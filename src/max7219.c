 ...
 * 
 * 
 *  This file contains the library functions fro controlling the 
 *  8x8 led displays based on the max7219 controller chip.
 * 
 *  This is a port of the library developed by Larry Bank for Arduino.
 * 
...
#include "../include/libled8x8/libled8x8.h"
#include "spi_config.h"
#include "prototypes.h"

/**************************************************
 * 
 *    Original Version comments and licence
 * 
 * ***********************************************/
 ...
 *  maxSendSequence()
 * 
 *  This function send a sequence of buytes via teh SPI port
 * 
 *  ver:    1.0
 * 
 *  date:   24-jun-23
 ...
 *  int max_init()
 * 
 *  This function initializes the 8x8 diaplays before thay can be used.
 * 
 *  ver:    1.0
 * 
 *  date:   24-jun-23
...
int maxInit(uint8_t iNum, uint8_t bDecodeMode, uint8_t iChannel, uint8_t iSelect)
{
   ...
   spi_init( SPI_PORT, SPI_RATE );             // set to 1 Mh
